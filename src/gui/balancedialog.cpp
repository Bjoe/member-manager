    ...
    QDialog(parent), balanceDao(), ui(), memberId(aMemberId)
{
    ...
    ui.balanceTableView->setColumnHidden(dao::BalanceTable::BalanceId, true);
    ui.balanceTableView->setColumnHidden(dao::BalanceTable::MemberId, true);
    ui.balanceTableView->sortByColumn(dao::BalanceTable::Date, Qt::DescendingOrder);
