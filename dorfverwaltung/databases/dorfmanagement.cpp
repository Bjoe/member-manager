...
Member::Member(const litesql::Database& db, const litesql::Record& rec)
    ...
    switch(size) {
    case 15: info = convert<const std::string&, std::string>(rec[14]);
        info.setModified(false);
    case 14: cashCollection = convert<const std::string&, bool>(rec[13]);
        cashCollection.setModified(false);
    case 13: city = convert<const std::string&, std::string>(rec[12]);
        city.setModified(false);
    case 12: zipCode = convert<const std::string&, int>(rec[11]);
        zipCode.setModified(false);
    case 11: street = convert<const std::string&, std::string>(rec[10]);
        street.setModified(false);
    case 10: email = convert<const std::string&, std::string>(rec[9]);
        email.setModified(false);
    case 9: dateOfLeaving = convert<const std::string&, litesql::Date>(rec[8]);
        dateOfLeaving.setModified(false);
    case 8: dateOfEntry = convert<const std::string&, litesql::Date>(rec[7]);
        dateOfEntry.setModified(false);
    case 7: nickname = convert<const std::string&, std::string>(rec[6]);
        nickname.setModified(false);
    case 6: firstName = convert<const std::string&, std::string>(rec[5]);
        firstName.setModified(false);
    case 5: surename = convert<const std::string&, std::string>(rec[4]);
        surename.setModified(false);
    case 4: deleted = convert<const std::string&, bool>(rec[3]);
        deleted.setModified(false);
    case 3: memberId = convert<const std::string&, int>(rec[2]);
...
Bank::Bank(const litesql::Database& db, const litesql::Record& rec)
    ...
    switch(size) {
    case 5: code = convert<const std::string&, int>(rec[4]);
        code.setModified(false);
    case 4: name = convert<const std::string&, std::string>(rec[3]);
        name.setModified(false);
    case 3: account = convert<const std::string&, int>(rec[2]);
...
Contribution::Contribution(const litesql::Database& db, const litesql::Record& rec)
    ...
    switch(size) {
    case 6: info = convert<const std::string&, std::string>(rec[5]);
        info.setModified(false);
    case 5: validFrom = convert<const std::string&, litesql::Date>(rec[4]);
        validFrom.setModified(false);
    case 4: donation = convert<const std::string&, int>(rec[3]);
        donation.setModified(false);
    case 3: fee = convert<const std::string&, int>(rec[2]);
...
Balance::Balance(const litesql::Database& db, const litesql::Record& rec)
    ...
    case 6: info = convert<const std::string&, std::string>(rec[5]);
        info.setModified(false);
    case 5: description = convert<const std::string&, std::string>(rec[4]);
        description.setModified(false);
    case 4: date = convert<const std::string&, litesql::Date>(rec[3]);
        date.setModified(false);
    case 3: amount = convert<const std::string&, int>(rec[2]);
...
Ressourcen::Ressourcen(const litesql::Database& db, const litesql::Record& rec)
    ...
    size_t size = (rec.size() > 5) ? 5 : rec.size();
    switch(size) {
    case 5: shellAccount = convert<const std::string&, std::string>(rec[4]);
        shellAccount.setModified(false);
    case 4: emailCCC = convert<const std::string&, std::string>(rec[3]);
        emailCCC.setModified(false);
    case 3: emailIntern = convert<const std::string&, std::string>(rec[2]);
